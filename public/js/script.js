document.addEventListener('DOMContentLoaded', function () {
   ...
   document.getElementById('addShareholderBtn').addEventListener('click', function () {
    ...
    cancelShareholderBtn.addEventListener('click', function () {
        addShareholderPopup.style.display = 'none'; // Hide the popup when cancel button is clicked
    });
    ...
    cancelStockBtn.addEventListener('click', function () {
        addStockPopup.style.display = 'none'; // Hide the popup when cancel button is clicked
});
