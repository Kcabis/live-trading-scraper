...
<div class="container">
    <div class="header">
        ...
        <select id="portfolioSelect" class="form-control" onchange="changePortfolio()">
                ...
                @else
                    ...
                    @foreach($transactions as $transaction)
                        <tr class="stock-row">
                            ...
                            <!-- Buy and Sell Amount Calculation -->
                            <td>
...
<script>
    function searchStock() {
        ...
        for (let i = 0; i < rows.length; i++) {
            ...
            rows[i].style.display = stockName.indexOf(input) > -1 ? "" : "none";
        }
    }

    function changePortfolio() {
        let selectedPortfolio = document.getElementById("portfolioSelect").value;
        if (selectedPortfolio) {
            window.location.href = `?portfolio_id=${selectedPortfolio}`;
        }
    }
</script>
@endpush
